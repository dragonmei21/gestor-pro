...
DEMO_LEDGER = [
    ...
    {"fecha": date(2025, 1, 25), "concepto": "Seguro responsabilidad civil", "contraparte": "Mapfre Seguros",
     ...
     "trimestre": "2025-Q1", "ejercicio": 2025},
    {"fecha": date(2025, 2, 25), "concepto": "Campaña Ads LinkedIn", "contraparte": "LinkedIn Ireland",
     "tipo": "gasto", "categoria": "marketing", "base_imponible": 520, "iva": 109.2, "irpf": 0, "total": 629.2,
     "estado_pago": "pagado", "fecha_pago": date(2025, 2, 26), "metodo_pago": "tarjeta",
     "trimestre": "2025-Q1", "ejercicio": 2025},
    {"fecha": date(2025, 3, 9), "concepto": "Equipo portátil diseño", "contraparte": "Apple Distribution",
     "tipo": "gasto", "categoria": "equipos", "base_imponible": 1850, "iva": 388.5, "irpf": 0, "total": 2238.5,
     "estado_pago": "pagado", "fecha_pago": date(2025, 3, 9), "metodo_pago": "tarjeta",
     "trimestre": "2025-Q1", "ejercicio": 2025},
    {"fecha": date(2025, 3, 22), "concepto": "Servicio de traducción documentación", "contraparte": "LinguaPro",
     "tipo": "gasto", "categoria": "servicios", "base_imponible": 210, "iva": 44.1, "irpf": 0, "total": 254.1,
     "estado_pago": "pendiente", "fecha_pago": None, "metodo_pago": None,
     "trimestre": "2025-Q1", "ejercicio": 2025},
    {"fecha": date(2025, 1, 30), "concepto": "Workshop UX en Madrid", "contraparte": "UX Institute",
     "tipo": "gasto", "categoria": "formacion", "base_imponible": 180, "iva": 37.8, "irpf": 0, "total": 217.8,
     "estado_pago": "pagado", "fecha_pago": date(2025, 2, 2), "metodo_pago": "tarjeta",
     "trimestre": "2025-Q1", "ejercicio": 2025},
    {"fecha": date(2025, 3, 25), "concepto": "Optimización SEO mensual", "contraparte": "Growth Lab",
     "tipo": "gasto", "categoria": "marketing", "base_imponible": 390, "iva": 81.9, "irpf": 0, "total": 471.9,
     "estado_pago": "pendiente", "fecha_pago": None, "metodo_pago": None,
     "trimestre": "2025-Q1", "ejercicio": 2025},
    {"fecha": date(2025, 1, 12), "concepto": "Branding + identidad visual", "contraparte": "Estudio Norte",
     "tipo": "ingreso", "categoria": "servicios", "base_imponible": 1500, "iva": 315, "irpf": -225, "total": 1590,
     "estado_pago": "pagado", "fecha_pago": date(2025, 1, 20), "metodo_pago": "transferencia",
     "trimestre": "2025-Q1", "ejercicio": 2025},
    {"fecha": date(2025, 2, 7), "concepto": "Sprint producto - SaaS analytics", "contraparte": "DataDrive",
     "tipo": "ingreso", "categoria": "servicios", "base_imponible": 3600, "iva": 756, "irpf": -540, "total": 3816,
     "estado_pago": "pagado", "fecha_pago": date(2025, 2, 14), "metodo_pago": "transferencia",
     "trimestre": "2025-Q1", "ejercicio": 2025},
    {"fecha": date(2025, 3, 4), "concepto": "Implementación CRM + onboarding", "contraparte": "RetailTech SL",
     "tipo": "ingreso", "categoria": "servicios", "base_imponible": 2100, "iva": 441, "irpf": -315, "total": 2226,
     "estado_pago": "pendiente", "fecha_pago": None, "metodo_pago": None,
     "trimestre": "2025-Q1", "ejercicio": 2025},
]
